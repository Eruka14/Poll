    ...
    return (   
        ...
        <nav className="w-full bg-white sticky top-0 z-10">
            <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                <Link to='/home'><h1 className="flex items-center p-3 text-2xl font-bold cursor-pointer">QuestionPoll<FcFaq className="ml-1" /></h1></Link>
                <ul className="flex gap-5 p-5 font-normal">
                   <Link to='/home'><li className="flex items-center cursor-pointer"><AiOutlineHome className="mr-1"/>Нүүр</li></Link>
